        ...
        <el-container>
            <el-header>
                <el-row :gutter="10">
                    <!-- 请输入用户名称 -->
                    <el-col :span="7">
                        <div class="grid-content bg-purple">用户昵称
                            <el-input size="medium" placeholder="请输入用户昵称" style="width: 180px" prefix-icon="el-icon-search"
                    ...
                    <el-col :span="7">
                        <div class="grid-content bg-purple">手机号
                            <el-input size="medium" placeholder="请输入手机号" style="width: 180px" prefix-icon="el-icon-search"
                                v-model="searchdata.phonenumber">
                            </el-input>
                        </div>
                    </el-col>
                    <el-col :span="7" class="el-col-last-button">
            ...
            <el-container>
                <el-aside width="200px">
                    <el-tree :data="departmentList" :props="defaultProps" accordion @node-click="handleNodeClick">
                    </el-tree>
                </el-aside>
                <el-main>
                    <!-- 其他导入导出批量操作 -->
                    <div style="margin: 10px;margin-left: 0px;">
                        <el-button type="success" @click="centerDialogVisibleAdd = true;
                        addPersonData();" icon="el-icon-circle-plus-outline">添加</el-button>
                        <!-- <el-button @click="toggleSelection()">取消选择</el-button>
                        <el-button @click="toggleSelection([tableData[1], tableData[2]])">切换第二、第三行的选中状态</el-button> -->
                    </div>
                    <!-- 表单 -->
                    <el-table ref="multipleTable" :data="personData" tooltip-effect="dark" style="width: 100%"
                        max-height="490px">
                        <el-table-column prop="userId" label="用户Id" width="135" align="center">
                        </el-table-column>
                        <el-table-column prop="nickName" label="用户昵称" width="135" align="center">
                        </el-table-column>
                        <el-table-column prop="deptName" label="部门" align="center">
                        </el-table-column>
                        <el-table-column prop="phonenumber" label="手机电话" align="center">
                        </el-table-column>
                        ...
                        <el-table-column label="操作" width="135" align="center">
                            <template slot-scope="scope">
                                <el-button type="primary" icon="el-icon-edit" circle size="mini" @click="
                                    centerDialogVisibleUpdate = true;
                                updatePersonData(scope.row);">
                                </el-button>
                                <el-button type="danger" icon="el-icon-delete" circle size="mini"
                                    @click="deletePersonData(scope.row)"></el-button>
                            </template>
                        </el-table-column>
                    </el-table>
                    <!-- 分页器 -->
                    <div class="block">
                        <el-pagination @size-change="handleSizeChange" @current-change="handleCurrentChange"
                            :current-page="tableForm.page" :page-sizes="[6, 8, 10, 12]" :page-size="tableForm.limit"
                            layout="total, sizes, prev, pager, next, jumper" :total="totalCount">
                        </el-pagination>
                    </div>
                    <!-- 修改操作弹出框 -->
                    <el-dialog title="提示" :visible.sync="centerDialogVisibleUpdate" width="45%" @close="close()" center>
                        <!-- 修改数据展示的form表格  -->
                    ...
                    <!-- 新增操作弹出框 -->
                    <el-dialog title="提示" :visible.sync="centerDialogVisibleAdd" width="45%" @close="close()" center>
                        <!-- 新增数据展示的form表格  -->
                        <el-form :model="ruleForm" :rules="rules" ref="ruleForm" label-width="100px" class="demo-ruleForm">
                            <el-form-item label="用户名称" prop="userId">
                                <el-input v-model="ruleForm.userId" :disabled="true"></el-input>
...
export default {
    ...
    methods: {
        ...
        handleNodeClick(sector) {
            ...
            this.$store.dispatch('allUser/getAllUserList', { ...this.searchdata, ...this.tableForm })//顶部按钮点击
        },
        //分页器数据
        ...
        addPersonData() {
            ...
            this.ruleForm.createTime = yy + '-' + mm + '-' + dd
        },
        //顶部事件
        clearAllInput() {
            this.searchdata.userName = ''
